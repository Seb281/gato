/**
 * Canonical UI strings — single source of truth for all apps.
 * API serves these to the LLM for translation. Extension and web
 * use them as English fallback defaults.
 */
